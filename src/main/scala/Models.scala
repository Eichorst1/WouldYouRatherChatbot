...
// Called when the user wants to see available difficulty/intensity levels
// e.g. "levels", "intensities", "difficulty"
case object ShowIntensities extends Intent

// Called when the user wants to see available moods/vibes
// e.g. "moods", "vibes"
case object ShowMoods extends Intent
